...
# Це перший рядок в калькуляторі, де з'являються усі числа
...
# Надпис знизу в калькуляторі
Label1=Label(text='This Calculator created by Dolomakin K.M. Kib20013')
Label1.place(relx=.05, rely=.9)
Label1['bg']='black'
Label1['fg']='red'
# Розміри клавіш
